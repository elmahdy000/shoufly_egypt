          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
             <div className="flex items-center gap-1 rounded-lg border border-slate-200 bg-slate-50 p-1 shadow-sm">
                {RANGE_OPTIONS.map((range) => (
                  <button
                    ...
                    className={`rounded-md px-5 py-1.5 text-[11px] font-bold transition-all uppercase tracking-tight ${
                      dateRange === range.key ? "bg-white text-slate-900 shadow-sm border border-slate-200" : "text-slate-400 hover:text-slate-600"
                    }`}
                  >
                    {range.label}
                  </button>
             ...
             <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="h-11 px-6 bg-slate-900 text-white rounded-lg text-xs font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/20 flex items-center gap-2 border border-slate-950"
                >
                  <Download size={16} />
                  تصدير البيانات
                </button>
                  ...
                  return (
                    <div key={item.day} className="flex-1 flex flex-col items-center gap-3 group">
                       <div className="relative w-full h-full flex items-end justify-center">
                          ...
                          />
                          <div className="absolute -top-8 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-slate-900 text-white text-[10px] font-bold px-2 py-1 rounded shadow-xl whitespace-nowrap z-20">
                             {item.requests} طلب
                          </div>
                       </div>
    ...
    <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
       ...
       <div className="relative z-10 space-y-4">
          ...
          <div>
             ...
             <h4 className="text-3xl font-black text-slate-900 tracking-tight font-jakarta mb-1 leading-none">{value}</h4>
