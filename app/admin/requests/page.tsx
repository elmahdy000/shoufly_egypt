    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-5 sm:space-y-6 min-h-screen" dir="rtl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
        {[
          ...
          { label: "نشط",           count: counts.active,   icon: Zap,         bg: "bg-white",   text: "text-gray-900",   iconBg: "bg-blue-100",    iconColor: "text-blue-700"   },
          { label: "مكتمل",         count: counts.done,     icon: CheckCircle, bg: "bg-white",   text: "text-gray-900",   iconBg: "bg-green-100",   iconColor: "text-green-700"  },
          { label: "ملغى",          count: counts.cancelled, icon: XCircle,     bg: "bg-white",   text: "text-gray-900",   iconBg: "bg-red-100",     iconColor: "text-red-700"    },
        ].map(s => {
          const Icon = s.icon;
          return (
            <div
